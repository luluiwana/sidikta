...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <section id="home-section" class="mt-5">
        <div class="row container">
            <div class="col-md-6">
                <img src="<?= base_url() ?>assets/img/vector/app-Online learning-pana 1.svg" class="w-100" alt="" srcset="">
            </div>
            <div class="col-md-6 text-center">
                <p class=" mt-3 text-black fs-30px"><span>Cara belajar seru dan asyik </span> </p>
                <p class="mb-4 text-black3">SIDIKTA merupakan aplikasi pembelajaran pendidikan kesetaraan untuk menunjang kegiatan pembelajaran daring</p>
                <div class="row">
                    <a href="<?= base_url() ?>auth/login/" class="btn  btn-yellow-big w-50">Masuk</a>
                    <a href="<?= base_url() ?>auth/daftar/" class="btn btn-grey-big w-50">Daftar</a>
